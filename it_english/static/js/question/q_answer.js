...
//アドバンス
  ...
  {question:'execute',answers:['拡張する','除外する','抽出する','実行する'],correct:'実行する'},
  {question:'excutable',answers:['実行可能ファイル','切り替えられる','一意の','不要な'],correct:'実行可能ファイル'},
  {question:'exclude',answers:['拡張する','除外する','抽出する','重複する'],correct:'除外する'},
  ...
  {question:'latency',answers:['機能','待ち時間','表現','実行時'],correct:'待ち時間'},
  ...
  {question:'transition',answers:['簡素化','分割','修正','遷移'],correct:'遷移'},
  {question:'typo',answers:['入力ミス','検証','列挙','拡張'],correct:'入力ミス'},
  {question:'tweak',answers:['微調整する','取得する','宣言する','変換する'],correct:'微調整する'},
  {question:'unique',answers:['一意の','静的な','生の','遠隔の'],correct:'一意の'},
